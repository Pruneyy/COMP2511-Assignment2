 ...
 * Reads in input data and adds it to the ShippingPlanner Class which holds a map of the system
...
public class ShippingPlanner {
	...
	/**
	 * Instantiates ShippingPlanner Class
	 */
	public ShippingPlanner() {
		this.m = new Map();
	...
	public static void main(String[] args) {
		ShippingPlanner sp = new ShippingPlanner();
		Scanner sc = null;
		try {
